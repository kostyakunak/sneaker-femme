...
A Resend extension for sending emails to customers.

> **Note**: This extension requires platform version 1.0.0 or higher.
...
// config/default.json
{
  ...
  "system": [
    ...
    "extensions": [
        ...
        {
          "name": "resend",
          "resolve": "node_modules/@shop/resend",
          "enabled": true,
          "priority": 10
        }
    ]
...
> **Note**: You can check the example email templates in the email_template_examples folder.
